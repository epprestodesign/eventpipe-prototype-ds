...
.rbd__cta { width: 100%; height: 52px; border-radius: var(--ds-radius-button); background: var(--ds-palette-slate-300); color: #fff; font-weight: 700; font-size: 1rem; pointer-events: none; transition: background var(--ds-duration-fast) var(--ds-ease-standard), color var(--ds-duration-fast) var(--ds-ease-standard); }
