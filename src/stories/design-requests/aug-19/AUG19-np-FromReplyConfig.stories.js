 ...
 *
 *  Renders the real fragment (`fromAddressSectionStrip` in _aug19.js), the same
 *  one both Notification Preferences screens use, so this story cannot drift
 *  from what ships.
 */
import { ref, computed } from 'vue'
import { FROM_ADDRESS_OPTIONS, FROM_ADDRESS_RESOLVED } from './_aug19fixtures'
import { fromAddressSectionStrip } from './_aug19'
import DsSelect from './components/DsSelect.vue'
import DsInput from './components/DsInput.vue'

export default {
  title: 'Design Requests/Aug 19/Components/Notification Preferences/From-Reply Section Config',
  tags: ['autodocs'],
