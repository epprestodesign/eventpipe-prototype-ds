 ...
 *
 *  Renders the real fragment (`unsavedChangesBar` in _aug19.js).
 */
import { ref } from 'vue'
import { unsavedChangesBar } from './_aug19'

export default {
  title: 'Design Requests/Aug 19/Components/Notification Preferences/Unsaved Changes Bar',
  tags: ['autodocs'],
