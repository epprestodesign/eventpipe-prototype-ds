 ...
 *
 *  The row renders the real fragment (`addReminderRow` in _aug19.js). The dialog
 *  is reproduced here because it lives inline in the screen story.
 */
import { ref } from 'vue'
import { addReminderRow } from './_aug19'
import DsInput from './components/DsInput.vue'

export default {
  title: 'Design Requests/Aug 19/Components/Notification Preferences/Add Compliance Reminder',
  tags: ['autodocs'],
