 ...
 */
import { ref } from 'vue'
import { colHeaders, templateActions, LIST_TITLE_STYLE, COL_SEND, COL_TMPL } from './_aug19'
import { TM_DESC } from './_aug19fixtures'
import DsListItem from './components/DsListItem.vue'

export default {
  title: 'Design Requests/Aug 19/Components/Notification Preferences/Template Group Labels',
  tags: ['autodocs'],
