...
import { COMPANY, EVENT, DEFAULT_EMAILS, MERGE_VALUES, FROM_ADDRESS_RESOLVED } from './_aug19fixtures'
import { emailPaper, mergeFieldToggle, renderBody, resolveMergeFields, OPEN, CLOSE } from './_aug19email'

export default {
  title: 'Design Requests/Aug 19/First-Time Setup/Default Emails',
  tags: ['autodocs'],
