...
import { aug19Page, eventHeader } from './_aug19shell'
import { EVENT, TM_TEMPLATES } from './_aug19fixtures'
import { addedTemplates } from './_aug19store'
import DsSelect from './components/DsSelect.vue'
import DsInput from './components/DsInput.vue'
import DsField from './components/DsField.vue'

export default {
  title: 'Design Requests/Aug 19/Screens/Event Registration Settings',
  tags: ['autodocs'],
...
export const Default = aug19Page({
  active: 'events',
...
export const Configured = aug19Page({
  active: 'events',
  components: { DsSelect, DsInput, DsField },
