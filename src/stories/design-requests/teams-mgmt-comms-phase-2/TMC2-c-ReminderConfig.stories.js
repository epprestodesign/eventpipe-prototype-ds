/** Teams Mgmt Comms Phase 2 / Components / Reminder Config → Phase-2 config panel (library only). */
import { ref } from 'vue'
...
export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Reminder Config',
  tags: ['autodocs'],
