/** Teams Mgmt Comms Phase 2 / Components / Announcement Notice → info notice (library + tokens only). */
export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Announcement Notice',
  tags: ['autodocs'],
