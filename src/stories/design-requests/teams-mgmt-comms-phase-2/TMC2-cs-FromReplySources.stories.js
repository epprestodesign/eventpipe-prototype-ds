 ...
 */
import { COMPANY, COMPANY_SECTIONS_TOP, COMPANY_SECTIONS_BOTTOM } from './_tmc2fixtures'
import DsInfoGrid from './components/DsInfoGrid.vue'
import DsSectionHeader from './components/DsSectionHeader.vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Company Settings/From-Reply Address Sources',
  tags: ['autodocs'],
