/** Teams Mgmt Comms Phase 2 / Components / Section Accordion → q-expansion-item + DsListItem (library only). */
import { ref } from 'vue'
import DsListItem from './components/DsListItem.vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Section Accordion',
  tags: ['autodocs'],
