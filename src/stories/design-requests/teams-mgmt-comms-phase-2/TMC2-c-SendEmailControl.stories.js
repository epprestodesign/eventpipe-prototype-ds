/** Teams Mgmt Comms Phase 2 / Components / Send-Email Control → Checkbox states (library only). */
import { ref } from 'vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Send-Email Control',
  tags: ['autodocs'],
