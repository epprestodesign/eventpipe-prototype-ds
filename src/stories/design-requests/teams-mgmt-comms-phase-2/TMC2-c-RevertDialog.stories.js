/** Teams Mgmt Comms Phase 2 / Components / Revert to Default Dialog → DsConfirmDialog.vue. */
import { ref } from 'vue'
import DsConfirmDialog from './components/DsConfirmDialog.vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Revert to Default Dialog',
