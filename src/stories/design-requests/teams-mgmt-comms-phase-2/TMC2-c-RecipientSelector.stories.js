/** Teams Mgmt Comms Phase 2 / Components / Recipient Selector → checkbox group (library only). */
import { ref } from 'vue'
import DsField from './components/DsField.vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Components/Recipient Selector',
  tags: ['autodocs'],
