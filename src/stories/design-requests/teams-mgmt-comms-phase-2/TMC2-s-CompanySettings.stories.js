...
import { COMPANY, COMPANY_SECTIONS_TOP, COMPANY_RECON, COMPANY_SECTIONS_BOTTOM } from './_tmc2fixtures'
import DsSectionHeader from './components/DsSectionHeader.vue'
import DsInfoGrid from './components/DsInfoGrid.vue'

export default {
  title: 'Design Requests/Teams Mgmt Comms Phase 2/Screens/Company Settings',
  tags: ['autodocs'],
...
export const CompanySettings = tmc2Page({
  active: 'none',
